...
import UpdatePasswordForm from "./my-favourites/update-password-form";
import DeleteAccountButton from "./my-favourites/delete-account-button";
  ...
  return (
    <div className="max-w-screen-md mx-auto">
      <Card className="mt-10">
        ...
        <CardContent>
          <Label>{decodedToken.email}</Label>
